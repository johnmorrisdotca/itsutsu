...
import { chooseBoard, chooseGame, chooseOpening, chooseOpponent, openMoreSettings, openSetUpPage } from "./support";
...
/*
 * The lobby sentence's case — that it named only a seat the set-up screen would
 * offer — went with the sentence on 2026-09-24, when New game became the one
 * place a game is set up. Which seat the set-up screen offers for which rules
 * is `seatMatch.test.ts`.
 */
