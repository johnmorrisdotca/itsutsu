...
| `README.md`, headline and "Forty-five games, in eight families" | 45 games in 8 families | true today (checked 2026-09-24), but typed by hand. It goes stale with the next game, and the tests that stop the About and home pages doing this do not read the README |
...
1. **The README counts from the catalogue.** Extend the About page's
   ...
   README states ("Forty-five games, in eight families") and fails when it is
