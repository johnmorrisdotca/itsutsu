...
function directoryRow(
  ...
  const here = gamesPlayed(entry.profile);
  /*
  ...
  return {
    ...
    record,
    /*
     * Rated games here, both pools, which is what `gamesPlayed` added up. A
     ...
     */
    of: { player: entry.name, rated: "yes", here: !kept },
    streak: entry.profile?.ratedStreak ?? null,
    rating,
