...
export const SHOTS = {
  ...
  setUp: { src: "/art/about/set-up.jpg", alt: "The set-up screen's list of bots, each with a grade or a style, with Rafa Duarte chosen.", ...DESK },
  vsComputer: { src: "/art/about/vs-computer.jpg", alt: "A Gomoku game against a bot: the board, the move list with Every position under it, private notes, the confirm switch, and a row of emoji and ready-made notes to send with a move.", ...DESK },
  ...
  computerPlayer: { src: "/art/about/computer-player.jpg", alt: "A bot's page, listing for each game how it measured against the grades on either side of it.", ...DESK },
