...
/**
 * Making a kana WordDrop puzzle from a seed: the word, and on easy and medium
 ...
 */
export function generateWordDropKana(size: number, level: PuzzleLevel, seed: number): Puzzle {
  ...
  return { kind: "wordDropKana", size, level, seed, givens: encodeKanaGivens(word, grey), solution: word };
}
