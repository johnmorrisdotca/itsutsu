 ...
 */
export function generateGomoji(size: number, level: PuzzleLevel, seed: number): Puzzle {
  ...
  return { kind: "gomoji", size, level, seed, givens: encodeHidden(word), solution: word };
}
