...
/**
 * Players remembered here, never played on Itsutsu. The first is the
 * site's first seeder — the record this whole feature was built to keep.
 * Add more the same way: a slug, a source, and the record as it stood.
 */
